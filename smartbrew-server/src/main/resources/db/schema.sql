...
('temp.control.enabled', '1', 'BOOLEAN', 'TEMP_CTRL', '自动温控总开关（1=开启/0=关闭）', 1),
('temp.control.heater-on', '18.00', 'DOUBLE', 'TEMP_CTRL', '低于此值开启加热（℃）', 1),
('temp.control.heater-off', '22.00', 'DOUBLE', 'TEMP_CTRL', '高于此值关闭加热（℃）', 1),
('temp.control.fan-on', '28.00', 'DOUBLE', 'TEMP_CTRL', '高于此值开启风扇（℃）', 1),
('temp.control.fan-off', '26.00', 'DOUBLE', 'TEMP_CTRL', '低于此值关闭风扇（℃）', 1),
